document.addEventListener('DOMContentLoaded', () => {
        ...
        musicToggleBtn.addEventListener('click', () => {
            if (ambientAudio.paused) {
                ambientAudio.play().then(() => {
                    ...
                    alert("Tap 'OK' and ensure interaction before playing audio.");
                });
            } else {
                ambientAudio.pause();
    ...
    // --- Calendar Planner Logic (Fully Functional & Robust) ---
    ...
    function renderPlans() {
        ...
        // Sort plans chronologically by date
    ...
    if (savePlanBtn && dateInput && textInput) {
        savePlanBtn.addEventListener('click', () => {
            ...
            textInput.value = '';
            renderPlans();
            addXP(15); // Reward XP for planning ahead!
        });
    }
